export const EVENTS_DATA = [
  ...
  },
  {
    ...
    summary: "ACM Student Chapter, VIT Bhopal organized an insightful webinar on 'Responsible AI: Reimagining AI for All', delivered by Dr. Rutvi Shah, Associate Professor at Ganpat University. The session focused on the ethical development and deployment of Artificial Intelligence, emphasizing fairness, transparency, accountability, and inclusivity in AI systems. Participants gained valuable insights into the importance of building trustworthy AI solutions while understanding the societal impact and future responsibilities of AI professionals.",
    highlights: [
      "Expert talk by Dr. Rutvi Shah",
  ...
  },
  {
    ...
    summary: "ACM Student Chapter, VIT Bhopal hosted 'The Placement Playbook', an interactive career guidance session featuring Parnika Chandra, an alumna of VIT Bhopal and Software Professional at Sprinklr. The session provided students with practical strategies for placement preparation, internship opportunities, resume building, interview readiness, and common mistakes to avoid during recruitment. Participants also had the opportunity to interact directly with the speaker through a live Q&A session and gain valuable industry insights.",
    highlights: [
      "Career Guidance from ACM Alumna",
      "Internship & Placement Strategies",
